...
if(isset($_GET['action'])){
    ...
    if ($_GET['action'] == "SaveSetting") { SaveSetting(); }
...
function postEdit()
{
    ...
    if (isset($_POST['id'])) {
        ...
        if (!count($errors) > 0) {
            ...
            $item_edit->set('city', $_POST['city']);
            $item_edit->set('location', $_POST['city']);
            $item_edit->set('state', $_POST['state']);
            $item_edit->set('country', $_POST['country']);
            $item_edit->set('description', $description);
            ...
            $item_edit->set('updated_at', $now);
            $item_edit->set('pro_days', $_POST['days']);
            $item_edit->set('pro_cvs', $_POST['cvs']);
            $item_edit->save();
...
function saveEmailTemplate(){
    ...
    if (isset($_POST['email_setting'])) {
        ...
        if($email_template == 0){
            ...
            update_option("email_to_admin_message_signup_details",validate_input($_POST['email_to_admin_testarea_message_signup_details']));
        ...
        update_option("email_to_admin_sub_signup_details",validate_input($_POST['email_to_admin_sub_signup_details']));
