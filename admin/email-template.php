                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="quickad-margin-top-xlg">
                                                            <div class="panel-group">
                                                                ...
                                                                <!--10.Create Account Details Email-->
                                                                <div class="panel panel-default quickad-js-collapse">
                                                                    <div class="panel-heading" role="tab" id="s_1">
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_10" aria-expanded="false" aria-controls="service_1">
                                                                                            Send to Admin User account details email </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div id="service_10" class="panel-collapse collapse" role="tabpanel" style="height: 0px;" aria-expanded="false">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_to_admin_sub_signup_details" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option("email_to_admin_sub_signup_details") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_to_admin_message_signup_details" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option("email_to_admin_message_signup_details") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_to_admin_message_signup_details" rows="10" class="form-control" placeholder="Enter Message"><?php echo stripcslashes(nl2br(get_option("email_to_admin_message_signup_details"))) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <table class="quickad-codes">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><input value="{UTYPE}" readonly="readonly" onclick="this.select()">- User Type</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>Language Shortcode find from this link. <a href="language_file.php?file=english" target="_blank"/>Click here</td>
                                                                                            </tr>
                    ...
                    <div id="quickad-tbs">
                        <div class="btn-group quickad-margin-bottom-lg quickad-services-holder">
                            ...
                            <ul class="dropdown-menu" style="width: 570px">
                                ...
                                <li class="quickad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="quickad-js-check-entity" value="any" id="send-to-Admin" name="send-to-Admin">
                                        <label for="send-to-Admin">	Send Notification to Admin for New User</label>
                                    </a>
                                </li>
                            </ul>
                        </div>
