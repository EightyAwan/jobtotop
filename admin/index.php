...
//custom Fields
$total_saved_item = ORM::for_table($config['db']['pre'].'product')->where('status','saved')->count();
$total_new_items = $total_pending_item + $total_saved_item;
                ...
                <a class="card bg-green bg-inverse" href="#">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            ...
                            <p class="h3 m-t-sm m-b-0"><?php echo $total_new_items; ?> New</p>
                        </div>
                        <div class="pull-left m-r">
