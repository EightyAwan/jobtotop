...
$item_days = $info['pro_days'];
$item_cvs = $info['pro_cvs'];
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="postEdit" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="city" id="city" class="form-control" value="<?php echo $item_city ?>" readonly="readonly" />
                                    <!-- <select name="city" id="city" class="form-control js-select2" data-placeholder="Select city..">
                                        <option selected="selected" value="<?php echo $item_city ?>" checked><?php echo $item_city;//get_cityName_by_id($item_city) ?></option>
                                    </select>-->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Custom Package:</label>
                                <div class="col-sm-8" style="margin-left: 10px">
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control days" name="days" value="<?php echo $item_days ?>" ><span></span> Days
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control cvs" name="cvs" value="<?php echo $item_cvs ?>" ><span></span> Cvs
                                    </div>
                                    <div class="col-sm-1">
                                        =
                                    </div> 
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control total" name="total" disabled value="<?php echo ($item_cvs * 1) + ($item_days * 3) ?>" ><span></span> Total Amount
                                    </div>
...
<script>
    $(document).on('change', '.days, .cvs', function() {
        var days = $('.days').val();
        var cvs = $('.cvs').val();
        var total = (days * 3) + (cvs * 1);
        var days = $('.total').val(total);
        //alert('Days are =>'+days+' | cvs are =>'+cvs + ' Total => '+total);
    });
