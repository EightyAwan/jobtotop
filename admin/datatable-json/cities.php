...
if($code_count == 1){
    $whr = "active = 1 and country_code = '".$country."'";
}
elseif($code_count == 2){
    $whr = "active = 1 and country_code = '".$country."' and subadmin1_code = '".$code."'";
}
elseif($code_count == 3){
    $whr = "active = 1 and country_code = '".$country."' and subadmin2_code = '".$code."'";
}
