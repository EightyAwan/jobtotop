 ...
 * @author Bizdesk
 * @Date: 27/June/2020
 * @Copyright (c) 2015-20 Bizdesk.com
 */
    ...
    if (trim($code) != '') {
        if(check_allow()){
            if(importGeonamesSql($con,$config,$code)){
                ...
                $con->query("UPDATE `".$config['db']['pre']."cities` set active='0'  WHERE `country_code` = '" . $code . "'");
                $con->query("UPDATE  `".$config['db']['pre']."subadmin1` set active='0'  where code like '%".$code."%'");
                $con->query("UPDATE `".$config['db']['pre']."subadmin2` set active='0'  where code like '%".$code."%'");
                echo 1;
            }
            else {
                echo 0;
...
function deleteCity()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."cities` set active='0'  ";
...
function deleteState()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql1 = "UPDATE `".$config['db']['pre']."subadmin1` set active='0' ";
        $sql2 = "UPDATE `".$config['db']['pre']."subadmin2` set active='0' ";
        $sql3 = "UPDATE `".$config['db']['pre']."cities` set active='0' ";
        foreach ($_POST['list'] as $value)
        {
...
function deleteDistrict()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql1 = "UPDATE `".$config['db']['pre']."subadmin2` SET `active`=0 ";
        $sql2 = "UPDATE `".$config['db']['pre']."cities` SET `active`=0 ";
        foreach ($_POST['list'] as $value)
        {
            $pieces = explode(".", $value);
            $country = $pieces[0];
...
function deleteCountry()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."countries` SET `active`=0 ";
        $sql2 = "UPDATE `".$config['db']['pre']."cities` SET `active`=0 ";
        $sql3 = "UPDATE `".$config['db']['pre']."subadmin1` SET `active`=0 ";
        $sql4 = "UPDATE `".$config['db']['pre']."subadmin2` SET `active`=0 ";
        foreach ($_POST['list'] as $value)
        {
            if($count == 0)
            {
...
function delete_ad_by_id($con,$config,$product_id){
    if(check_allow()){
        $qry1 = "UPDATE `".$config['db']['pre']."product` SET `active`=0 WHERE id = '$product_id' LIMIT 1";
...
function delete_resubmitad_by_id($con,$config,$product_id){
    if(check_allow()){
        $reqry1 = "UPDATE `".$config['db']['pre']."product_resubmit` SET `active`=0 WHERE product_id = '$product_id' LIMIT 1";
    ...
    if (trim($id) != '') {
        if(check_allow()) {
            ...
            if($row > 0){
                ...
                $con->query("UPDATE `" . $config['db']['pre'] . "product_resubmit` SET `active`=2 WHERE `product_id` = '" . $_POST['id'] . "' LIMIT 1");
...
function approveitem()
{
    ...
    if (trim($id) != '') {
        if(check_allow()){
            ...
            $query = "SELECT product_name,user_id,comm_email from `".$config['db']['pre']."product` WHERE `id` = '".$id."' LIMIT 1";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $item_title = $info['product_name'];
                $item_author_id = $info['user_id'];
                $alt_email = $info['comm_email'];
                /*SEND RESUBMISSION AD APPROVE EMAIL*/
                email_template("ad_approve",$item_author_id,null,$product_id,$item_title,$alt_email);
            }
        }
...
function deleteusers()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."user` SET `active`=0 ";
...
function deleteCurrency()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."currencies` SET `active`=0 ";
...
function deleteTimezone()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."time_zones` SET `active`=0 ";
...
function deleteNoresult()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."search_noresult` SET `active`=0 ";
...
function deleteMembershipPlan()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."subscriptions` SET `active`=0 ";
...
function deletePackage()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."usergroups` SET `active`=0 ";
...
function deleteadmin()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."admins` SET `active`=0 ";
...
function deleteMessage()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."messages` SET `active`=0 ";
...
function deleteads()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."product`  SET `active`=0 ";
...
function deleteCompany(){
    ...
    {
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."companies` SET `active`=0 ";
        $sql2 = "SELECT logo FROM `".$config['db']['pre']."companies` ";
        $delete_product = "UPDATE `".$config['db']['pre']."product` SET `active`=0 ";
        $delete_reproduct = "UPDATE `".$config['db']['pre']."product_resubmit` SET `active`=0 ";
        foreach ($_POST['list'] as $value)
        {
            if($count == 0)
            {
...
function deleteResume(){
    ...
    {
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."resumes` SET `active`='0' ";
...
function deleteResubmitItem()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."product_resubmit` SET `active`=0 ";
...
function deleteTransaction()
{
    ...
    if (is_array($_POST['list'])) {
        ...
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."transaction` SET `active`=0 ";
...
function deleteCat()
{
    ...
    if (trim($id) != '') {
        if(check_allow()){
            if ($con->query("UPDATE `".$config['db']['pre']."catagory_main` SET `active`=0 WHERE `cat_id` = '" . $id . "'")) {
                $con->query("UPDATE `".$config['db']['pre']."category_translation` SET `active`=0 WHERE `translation_id` = '" . $id . "' and category_type = 'main' ");
                ...
                {
                    $id = $row['sub_cat_id'];
                    $con->query("UPDATE `".$config['db']['pre']."catagory_sub` SET `active`=0 WHERE `sub_cat_id` = '" . $id . "'");
                    $con->query("UPDATE `".$config['db']['pre']."category_translation` SET `active`=0 WHERE `translation_id` = '" . $id . "' and category_type = 'sub' ");
                }
...
function delSubCat()
{
    ...
    if (is_array($subCatids)) {
        foreach ($subCatids as $subCatid) {
            if(check_allow()){
                $con->query("UPDATE `".$config['db']['pre']."catagory_sub` SET `active`=0 WHERE `sub_cat_id` = '" . $subCatid . "'");
                $con->query("UPDATE `".$config['db']['pre']."category_translation` SET `active`=0 WHERE `translation_id` = '" . $subCatid . "' and category_type = 'sub'");
            }
        }
        echo 1;
        die();
...
function getSubCat()
{
    ...
    if ($id > 0) {
        $query = "SELECT * FROM `".$config['db']['pre']."catagory_sub` WHERE main_cat_id = ".$id." AND `active`=1 ORDER by cat_order ASC";
    } else {
        $query = "SELECT * FROM `".$config['db']['pre']."catagory_sub` WHERE AND `active`=1 ORDER by cat_order ASC";
    }
...
function getsubcatbyid()
{
    ...
    $query = "SELECT * FROM `" . $config['db']['pre'] . "catagory_sub` WHERE `active`=1 AND main_cat_id = " . $id;
    if ($result = $con->query($query)) {
...
function delPostType(){
    ...
    if (is_array($ids)) {
        foreach ($ids as $id) {
            if(check_allow()){
                echo $sql =  "UPDATE `".$config['db']['pre']."product_type` SET `active`='0' WHERE `id` = '" . $id . "'";
                $con->query($sql);
            }
        }
        echo 1;
...
function delSalaryType(){
    ...
    if (is_array($ids)) {
        foreach ($ids as $id) {
            if(check_allow()){
                $con->query("UPDATE `".$config['db']['pre']."salary_type` SET `active`='0' WHERE `id` = '" . $id . "'");
            }
        }
        echo 1;
        die();
...
function getStateByCountryID()
{
    ...
    $query = "SELECT id,code,name FROM `".$config['db']['pre']."subadmin1` WHERE `active`=1 AND country_code = '".$country_id."' ORDER BY name";
    if ($result = $con->query($query)) {
...
function getDistrictSelectedforCityAdd()
{
    ...
    $query = "SELECT id,code,name FROM `".$config['db']['pre']."subadmin2` WHERE `active`=1 AND  subadmin1_code = '".$code."' ORDER BY name";
    if ($result = $con->query($query)) {
...
function getCityByStateID()
{
    ...
    $query = "SELECT id ,name FROM `".$config['db']['pre']."cities` WHERE `active`=1 AND subadmin1_code = '".$state_id."' and country_code = '$country_code'" ;
    $result = $con->query($query);
    if ($result){
        if(mysqli_num_rows($result) > 0){
...
function searchCityStateCountry()
{
    ...
    WHERE c.active=1 and s.active and c.asciiname like '%$dataString%' and c.country_code = '$sortname'
    ORDER BY
    CASE
...
function getlocHomemap()
{
    ...
    if ($city != '') {
        ...
        $query = "SELECT * FROM `".$config['db']['pre']."product`  WHERE `active`=1 AND `status` = '$appr' $where ";
    }
...
function openlocatoionPopup()
{
    ...
    $query = "SELECT * FROM `".$config['db']['pre']."product` WHERE `active`=1 AND id = '" . $_POST['id'] . "' LIMIT 1";
    $query_result = mysqli_query ($con, $query);
    $data = array();
    $i = 0;
    if ($query_result->num_rows > 0) {
        while ($result = mysqli_fetch_array($query_result)) {
            ...
            $caticonquery = "SELECT * FROM `".$config['db']['pre']."catagory_main`  WHERE `active`=1 AND `cat_id` = '$cat' LIMIT 1";
            $caticonres = mysqli_query ($con, $caticonquery);
            $fetch = mysqli_fetch_array($caticonres);
            $catIcon = $fetch['icon'];
            $catname = $fetch['cat_name'];
...
function deleteBlog(){
    ...
    {
        $count = 0;
        $sql = "UPDATE `".$config['db']['pre']."blog` SET `active`=0  ";
        ...
        foreach ($_POST['list'] as $value)
        {
            ...
            {
                $sql.= "WHERE `id` = '" . $value . "'";
                $sql2.= "WHERE `active`=1 AND `id` = '" . $value . "'";
            }
            else
            {
                $sql.= " OR `id` = '" . $value . "'";
...
function delBlogCat(){
    ...
    if (is_array($ids)) {
        foreach ($ids as $id) {
            if(check_allow()){
                $con->query("UPDATE `".$config['db']['pre']."blog_categories` WHERE SET `active`=1 AND `id` = '" . $id . "'");
            }
        }
        echo 1;
        die();
