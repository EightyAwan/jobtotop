...
if(isset($_POST['submit']))
{
    ...
    <?php
        ...
        function install_chat_setting($code){
            ...
            $url = "https://BizDesk/Esystematics.com/api/api.php?verify-purchase=" . $code . "&version=" . $installing_version . "&site_url=" . $site_url . "&email=" . $buyer_email;
            // Open cURL channel
            $ch = curl_init();
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane hidden" id="quickchat_websocket">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="help-block">For more information on how to start websocket see this <a href="https://BizDesk/Esystematics.ticksy.com/article/15905/" target="_blank">article</a>.</p>
                                                    </div>
