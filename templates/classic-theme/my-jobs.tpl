                            ...
                            <div class="dashboard-nav-inner">
                              ...
                              <ul data-submenu-title="{LANG_MY_JOBS}">
                                ...
                                <li class="active"><a href="{LINK_MYJOBS}"><i class="icon-feather-briefcase"></i> {LANG_MY_JOBS} <span class="nav-tag">{MYADS}</span></a></li>
                                    <li><a href="{LINK_SAVEDJOBS}"><i class="icon-feather-clock"></i> {LANG_SAVED_JOBS} <span class="nav-tag">{SAVEDADS}</span></a></li> <!-- Custom Fields -->
                ...
                <div class="dashboard-box margin-top-0">
                    ...
                    <div class="content with-padding">
                        ...
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list myjobs">
                                <tr>
                                ...
                                <tr class="ajax-item-listing IF('{ITEM.hide}'=='1'){ opapcityLight {:IF}" data-item-id="{ITEM.id}">
                                    ...
                                    <td>
                                        ...
                                        <select id="select_check_active" class="select_check_active" style="width: 120px;">
                                            <option value="active" IF("{ITEM.status}"=="active"){ selected {:IF}>Active</option>
                                            <option value="pending" IF("{ITEM.status}"=="pending"){  selected {:IF}>Pending</option>
