    ...
    <table id="datatable">
        <thead>
            <tr>
                ...
                <th class="small-width">Invoice</th>
            </tr>
        </thead>
        IF("{T_BLANK}"=="0"){
        <tbody>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>IF('{TRANSACTIONS.payment_by}'=="stripe"){ Card Payment {:IF}
                IF('{TRANSACTIONS.payment_by}'=="paypal"){ paypal {:IF}
                </td>
                <td>{TRANSACTIONS.time}</td>
                <td>{TRANSACTIONS.status}</td>
                <td><a class="btn btn-success" target="_BLANK" href="{TRANSACTIONS.invoice}">View Invoice</a> </td>
            </tr>
            {/LOOP: TRANSACTIONS}
        </tbody>
        {:IF}
