                ...
                <div class="payment margin-top-30">
                    ...
                    <div class="payment-tab">
                        <div class="payment-tab-trigger">
                            ...
                            <img class="payment-logo my_simg" src="{SITE_URL}includes/payments/{PAYMENT_TYPES.folder}/logo/logo.png" alt="">
                        </div>

                        <div class="payment-tab-content">
                            <div class="row payment-form-row">
                                <div class="col-12">
                                    <div class="card-label form-group my_lab" style="margin-top: 40px;">
                                        <label class="my_label">NAME ON THE CARD</label>
                                        <input type="text" class="form-control my_input" name="stripeCardholderName" placeholder=""  required autofocus/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="card-label form-group my_lab">
                                        <label class="my_label">{LANG_CARD_NUMBER}</label>
                                        <input type="text" class="form-control my_input" name="stripeCardNumber" placeholder="" autocomplete="cc-number" required autofocus/>
                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="card-label form-group my_lab">
                                         <label class="my_label">Expiry date</label>
                                        <input type="tel" class="form-control my_input" name="stripeCardExpiry" placeholder="MM/YYYY" autocomplete="cc-exp" required/>
                                    </div>
                                </div>
                                <div class="col-sm-5 pull-right">
                                    <div class="card-label form-group my_lab">
                                          <label class="my_label">CVV/CVC</label>
                                        <input type="tel" class="form-control my_input" name="stripeCardCVC" placeholder="" autocomplete="cc-csc" required/>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <span class="PaymentMethod-info">{CURRENCY_SIGN}{total_amount}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div class="boxed-widget summary margin-top-0">
                ...
                <div class="boxed-widget-inner">
                    <ul>
                        ...
                        <li>Invoice Number <span># 1001</span></li>
                        <li>{LANG_ORDER} <span>{ORDER_DESC}</span></li>
                        <li class="total-costs">Package Cost <span>{CURRENCY_SIGN}{AMOUNT} {CURRENCY_CODE}</span></li>
                        <li class="total-costs">VAT 5% Cost <span  id="vat" >{CURRENCY_SIGN}{percentage_amount} {CURRENCY_CODE}</span></li>
                        <li class="total-costs">{LANG_TOTAL_COST} <span  id="totalprice">{CURRENCY_SIGN}{total_amount} {CURRENCY_CODE}</span></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    var num = {percentage_amount};
    num = num.toFixed(2);
    vat.innerHTML = "{CURRENCY_SIGN}" + num + " {CURRENCY_CODE}" ;
    
    var num2 = {total_amount};
    num2 = num2.toFixed(2);
    totalprice.innerHTML = "{CURRENCY_SIGN}" + num2 + " {CURRENCY_CODE}" ;
