...
<div id="titlebar" class="margin-bottom-0">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>{LANG_SAVED_JOBS}</h1>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{LINK_INDEX}">{LANG_HOME}</a></li>
                        <li>{LANG_SAVED_JOBS}</li>
                    </ul>
                </nav>
        ...
        <div class="row">
                        ...
                        <div class="dashboard-nav-container">
                            ...
                            <div class="dashboard-nav-inner">
                              ...
                              <ul data-submenu-title="{LANG_MY_JOBS}">
                                ...
                                <li class="active"><a href="{LINK_SAVEDJOBS}"><i class="icon-feather-clock"></i> {LANG_SAVED_JOBS} <span class="nav-tag">{SAVEDADS}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-clock"></i> {LANG_SAVED_JOBS}</h3>
                    </div>
                            ...
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                <tr class="ajax-item-listing" data-item-id="{ITEM.id}">
                                    ...
                                    <td>
                                        ...
                                        IF("{ITEM.status}"=="saved"){ <span class="badge blue">{ITEM.status}</span> {:IF}
                                ...
                                {ELSE}
                                <tr>
                                    <td colspan="3" class="text-center">{LANG_NO_SAVED_JOB}</td>
                                </tr>
                                {:IF}
                            </table>
                        </div>
