...
if(isset($_POST['payment_method_id']))
{
    ...
    if (isset($_SESSION['quickad'][$access_token]['payment_type'])) {
        ...
        $percentage_amount = $_SESSION['quickad'][$access_token]['percentage_amount'];
        $total_amount = $_SESSION['quickad'][$access_token]['total_amount'];
        ...
        $page->SetParameter ('percentage_amount', $percentage_amount);
        $page->SetParameter ('total_amount', $total_amount);
