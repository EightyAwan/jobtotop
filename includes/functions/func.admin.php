...
function admin_session_start() {
    ...
    $lifetime = strtotime('+1 months', 0);
    session_set_cookie_params($lifetime,$cookieParams["lifetime"], $cookieParams["path"], $cookieParams["domain"], $secure, $httponly);
...
function adminlogin($email,$password,$role='admin'){
