...
$link['SITES'] = $config['site_url'] . 'sites';
$link['JOB_SEEKERS'] = $config['site_url'] . 'job-seekers';
$link['POST-DETAIL'] = $config['site_url'] . 'job';
$link['POST-REVIEW'] = $config['site_url'] . 'review'; //New URL REVIEW
$link['INVOICE'] = $config['site_url'] . 'invoice';// NEW URL INVOICE
...
$link['SAVEDJOBS'] = $config['site_url'] . 'saved';
